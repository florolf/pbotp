 ...
 * SPDX-FileCopyrightText: Markku-Juhani O. Saarinen <mjos@iki.fi>
 *
 * Adapted from https://github.com/mjosaarinen/blake2_mjosref/
 */
...
static void test_blake2s(void **state)
{
	(void) state;

	assert_int_equal(blake2s_selftest(), 0);
}
...
int main(int argc, char **argv)
{
	...
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_blake2s),
	};

	return cmocka_run_group_tests_name("blake2s", tests, NULL, NULL);
}
