...
static void test_challenge(void **state)
{
	...
	uint8_t nonce[] = {
		0x41, 0xdc, 0xc4, 0x6f, 0x88, 0xe9, 0xeb, 0xa5, 0x64, 0xa2, 0x3d, 0x7d, 0xdb, 0x10, 0x0d, 0xbd,
		0x7d, 0xa7, 0xac, 0x17, 0xce, 0xca, 0xf9, 0xa1, 0x0d, 0x4d, 0xb8, 0xfd, 0xb6, 0x84, 0xb7, 0xbf
	};
	...
	uint8_t expected_challenge[] = {
		0xd1, 0x21, 0x72, 0x8e, 0xd9, 0xfe, 0xf9, 0xdc, 0xf4, 0x2b, 0xca, 0xdf, 0x0a, 0x60, 0xde, 0xb0,
		0x71, 0x34, 0xf1, 0x89, 0x6f, 0xb7, 0x99, 0x1f, 0x16, 0x84, 0xdd, 0xdd, 0x6b, 0xa8, 0xb6, 0x23
	};
	assert_memory_equal(challenge, expected_challenge, 32);

	uint8_t expected_response[] = {
		0x84, 0x71, 0xdb, 0x1f, 0x5c, 0x03, 0xf7, 0x51, 0xfd, 0x88, 0x5f, 0x7c, 0x31, 0x86, 0x2d, 0x16,
		0xd6, 0xf3, 0xa7, 0x78, 0x98, 0xbd, 0x2a, 0xdc, 0x2c, 0xeb, 0x29, 0xad, 0x1d, 0x6d, 0x63, 0x3b,
	};
...
static void test_code(void **state)
{
	...
	assert_string_equal(code, "526044548");
}
...
static void test_phrase(void **state)
{
	...
	assert_string_equal(phrase, "correct horse avocado cupboard unlock");
}
